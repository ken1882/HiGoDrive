class Util{
  ...
  static initialize(){
    this.RAILS_AUTH_TOKEN = AUTH_TOKEN;
  ...
  static initBrowserCheck(){
    ...
    // Whether is mobile
    this.isMobile = function(){var check = false;
  ...
  static isWebGLSupported(){
    try{
      ...
      return !!(!!window.WebGLRenderingContext && (_canvas.getContext('webgl') || _canvas.getContext('experimental-webgl')));
    }
    catch(e){
      return false;
    }
